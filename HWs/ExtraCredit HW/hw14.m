...
%    check1a = visdiff('lyrics1_reordered_soln.txt','lyrics1_reordered.txt')
%    check1b = visdiff('lyrics1_reordered_soln.txt','lyrics1_reordered.txt')
...
%    check1 = checkImage('puzzled',filename1, pos1)
%
%    puzzled(filename2, pos2)
%    puzzled_soln(filename2, pos2)
%    check2 = checkImage('puzzled',filename2, pos2)
% 
%    puzzled(filename3, pos3)
%    puzzled_soln(filename3, pos3)
%    check3 = checkImage('puzzled',filename3, pos3)
%
%